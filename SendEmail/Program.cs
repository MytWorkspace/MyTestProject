    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                senderServerIp = "smtp.qq.com ";  //qq  发送方邮箱服务器地址  
                ...
                toMailAddress = "373900329@qq.com";   //收件人地址
  
                string fromMailAddress = "mingmingruyuedlut@163.com";

                fromMailAddress = "582784445@qq.com";  //发件人地址

                string subjectInfo = "Test sending e_mail";   //发送邮箱标题
                

                string bodyInfo = "Hello Eric, This is my first testing e_mail";   //发送邮箱 内容

                string mailUsername = "mingmingruyuedlut";    //用户名 
                mailUsername = "582784445@qq.com";
                string mailPassword = ".........."; //发送邮箱的密码（）   

                mailPassword = "zhangoufeiqqj321";
                mailPassword = "gaxeulkrfevvbbdi";  //qq授权码

                string mailPort = "25";

                string attachPath = @"D:\360安全浏览器下载\PanDownloadLBW3.4.zip; D:\360安全浏览器下载\苏飞主页（fiddler例子）.rar";
